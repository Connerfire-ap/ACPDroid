...
.method public constructor <init>([CI)V
    ...
    iput-object v0, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->counterBlock:[B
...
.method private deriveKey([B[C)[B
    ...
    .line 110
    :try_start_0
    new-instance v2, Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Parameters;
    ...
    invoke-direct {v2, v3, v4, p1, v5}, Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Parameters;-><init>(Ljava/lang/String;Ljava/lang/String;[BI)V

    .line 112
    .local v2, "p":Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Parameters;
    new-instance v1, Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Engine;

    invoke-direct {v1, v2}, Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Engine;-><init>(Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Parameters;)V

    .line 113
    .local v1, "e":Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Engine;
    iget v3, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->KEY_LENGTH:I
    ...
    invoke-virtual {v1, p2, v3}, Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Engine;->deriveKey([CI)[B
    :try_end_0
    ...
    .end local v2    # "p":Lnet/lingala/zip4j/crypto/PBKDF2/PBKDF2Parameters;
    :catch_0
    move-exception v1
...
.method private init()V
    ...
    .line 73
    iget v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->keyStrength:I
    ...
    iput v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->SALT_LENGTH:I

    .line 88
    :goto_0
    iget v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->SALT_LENGTH:I

    invoke-static {v1}, Lnet/lingala/zip4j/crypto/AESEncrpyter;->generateSalt(I)[B

    move-result-object v1

    iput-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->saltBytes:[B

    .line 89
    iget-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->saltBytes:[B

    iget-object v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->password:[C

    invoke-direct {p0, v1, v2}, Lnet/lingala/zip4j/crypto/AESEncrpyter;->deriveKey([B[C)[B
    ...
    :pswitch_2
    iput v3, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->KEY_LENGTH:I

    .line 81
    iput v3, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->MAC_LENGTH:I
    ...
    iput-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->macKey:[B

    .line 97
    new-array v1, v5, [B

    iput-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->derivedPasswordVerifier:[B
    ...
    .line 105
    iget-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->mac:Lnet/lingala/zip4j/crypto/PBKDF2/MacBasedPRF;
...
.method public encryptData([BII)I
    ...
    .line 130
    iget-boolean v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->finished:Z
    ...
    iput-boolean v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->finished:Z
    ...
    iget v4, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->nonce:I

    invoke-static {v2, v4, v3}, Lnet/lingala/zip4j/util/Raw;->prepareBuffAESIVBytes([BII)V
    ...
    .local v1, "k":I
    :goto_2
    iget v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->loopCount:I
