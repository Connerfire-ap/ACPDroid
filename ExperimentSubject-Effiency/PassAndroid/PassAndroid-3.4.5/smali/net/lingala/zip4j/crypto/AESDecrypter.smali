...
.method private init([B[B)V
    ...
    .line 69
    iget-object v2, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->localFileHeader:Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    invoke-virtual {v2}, Lnet/lingala/zip4j/model/LocalFileHeader;->getAesExtraDataRecord()Lnet/lingala/zip4j/model/AESExtraDataRecord;
    ...
    invoke-virtual {v2}, Lnet/lingala/zip4j/model/LocalFileHeader;->getPassword()[C
    ...
    .line 85
    :pswitch_1
    iput v4, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->KEY_LENGTH:I

    .line 86
    iput v4, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->MAC_LENGTH:I
    ...
    .line 90
    :pswitch_2
    iput v7, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->KEY_LENGTH:I

    .line 91
    iput v7, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->MAC_LENGTH:I
    ...
    invoke-direct {p0, p1, v2}, Lnet/lingala/zip4j/crypto/AESDecrypter;->deriveKey([B[C)[B
    ...
    .line 112
    iget-object v2, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->aesKey:[B
...
.method public decryptData([BII)I
    ...
    :goto_1
    :try_start_0
    iput v3, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->loopCount:I

    .line 141
    iget-object v3, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->mac:Lnet/lingala/zip4j/crypto/PBKDF2/MacBasedPRF;

    iget v5, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->loopCount:I

    invoke-virtual {v3, p1, v1, v5}, Lnet/lingala/zip4j/crypto/PBKDF2/MacBasedPRF;->update([BII)V

    .line 142
    iget-object v3, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->iv:[B

    iget v5, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->nonce:I

    const/16 v6, 0x10

    invoke-static {v3, v5, v6}, Lnet/lingala/zip4j/util/Raw;->prepareBuffAESIVBytes([BII)V

    .line 143
    iget-object v3, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->aesEngine:Lnet/lingala/zip4j/crypto/engine/AESEngine;

    iget-object v5, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->iv:[B

    iget-object v6, p0, Lnet/lingala/zip4j/crypto/AESDecrypter;->counterBlock:[B

    invoke-virtual {v3, v5, v6}, Lnet/lingala/zip4j/crypto/engine/AESEngine;->processBlock([B[B)I
