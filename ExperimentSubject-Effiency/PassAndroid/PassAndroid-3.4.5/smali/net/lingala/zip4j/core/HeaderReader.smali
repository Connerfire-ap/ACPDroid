...
.method private readAESExtraDataRecord(Ljava/util/ArrayList;)Lnet/lingala/zip4j/model/AESExtraDataRecord;
    ...
    invoke-virtual {v1, v10, v11}, Lnet/lingala/zip4j/model/AESExtraDataRecord;->setSignature(J)V
    ...
    .line 1068
    .local v0, "aesData":[B
    invoke-static {v0, v9}, Lnet/lingala/zip4j/util/Raw;->readShortLittleEndian([BI)I
...
.method private readCentralDirectory()Lnet/lingala/zip4j/model/CentralDirectory;
    ...
    .line 191
    new-instance v28, Lnet/lingala/zip4j/exception/ZipException;

    const-string v29, "random access file was null"

    const/16 v30, 0x3

    invoke-direct/range {v28 .. v30}, Lnet/lingala/zip4j/exception/ZipException;-><init>(Ljava/lang/String;I)V
    ...
    invoke-virtual/range {v28 .. v28}, Lnet/lingala/zip4j/model/ZipModel;->getEndCentralDirRecord()Lnet/lingala/zip4j/model/EndCentralDirRecord;
    ...
    invoke-direct/range {v28 .. v29}, Lnet/lingala/zip4j/exception/ZipException;-><init>(Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_0
    new-instance v5, Lnet/lingala/zip4j/model/CentralDirectory;

    invoke-direct {v5}, Lnet/lingala/zip4j/model/CentralDirectory;-><init>()V

    .line 200
    .local v5, "centralDirectory":Lnet/lingala/zip4j/model/CentralDirectory;
    ...
    .line 203
    .local v8, "endCentralDirRecord":Lnet/lingala/zip4j/model/EndCentralDirRecord;
    ...
    invoke-virtual/range {v28 .. v28}, Lnet/lingala/zip4j/model/ZipModel;->isZip64Format()Z
    ...
    invoke-virtual/range {v28 .. v28}, Lnet/lingala/zip4j/model/ZipModel;->getZip64EndCentralDirRecord()Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;

    move-result-object v28

    invoke-virtual/range {v28 .. v28}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->getOffsetStartCenDirWRTStartDiskNo()J
    ...
    invoke-virtual/range {v28 .. v28}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->getTotNoOfEntriesInCentralDir()J
    ...
    .end local v5    # "centralDirectory":Lnet/lingala/zip4j/model/CentralDirectory;
    .end local v8    # "endCentralDirRecord":Lnet/lingala/zip4j/model/EndCentralDirRecord;
    ...
    .restart local v5    # "centralDirectory":Lnet/lingala/zip4j/model/CentralDirectory;
    .restart local v8    # "endCentralDirRecord":Lnet/lingala/zip4j/model/EndCentralDirRecord;
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setSignature(I)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setVersionMadeBy(I)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setVersionNeededToExtract(I)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setFileNameUTF8Encoded(Z)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setEncrypted(Z)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setGeneralPurposeFlag([B)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setDataDescriptorExists(Z)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setCompressionMethod(I)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setLastModFileTime(I)V
    ...
    invoke-virtual {v12, v0, v1}, Lnet/lingala/zip4j/model/FileHeader;->setCrc32(J)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setCrcBuff([B)V
    ...
    invoke-virtual {v12, v0, v1}, Lnet/lingala/zip4j/model/FileHeader;->setCompressedSize(J)V
    ...
    invoke-virtual {v12, v0, v1}, Lnet/lingala/zip4j/model/FileHeader;->setUncompressedSize(J)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setFileNameLength(I)V
    ...
    invoke-virtual {v12, v9}, Lnet/lingala/zip4j/model/FileHeader;->setExtraFieldLength(I)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setFileComment(Ljava/lang/String;)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setDiskNumberStart(I)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setInternalFileAttr([B)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setExternalFileAttr([B)V
    ...
    invoke-virtual {v12, v0, v1}, Lnet/lingala/zip4j/model/FileHeader;->setOffsetLocalHeader(J)V
    ...
    invoke-direct {v0, v1, v15}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-virtual/range {v28 .. v28}, Lnet/lingala/zip4j/model/ZipModel;->getFileNameCharset()Ljava/lang/String;

    move-result-object v28

    invoke-static/range {v28 .. v28}, Lnet/lingala/zip4j/util/Zip4jUtil;->isStringNotNullAndNotEmpty(Ljava/lang/String;)Z
    ...
    invoke-static {v15, v0}, Lnet/lingala/zip4j/util/Zip4jUtil;->decodeFileName([BZ)Ljava/lang/String;
    ...
    .line 330
    :cond_9
    invoke-virtual {v12, v14}, Lnet/lingala/zip4j/model/FileHeader;->setFileName(Ljava/lang/String;)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setDirectory(Z)V
    ...
    invoke-direct {v0, v12}, Lnet/lingala/zip4j/core/HeaderReader;->readAndSaveExtraDataRecord(Lnet/lingala/zip4j/model/FileHeader;)V

    .line 341
    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Lnet/lingala/zip4j/core/HeaderReader;->readAndSaveZip64ExtendedInfo(Lnet/lingala/zip4j/model/FileHeader;)V

    .line 344
    move-object/from16 v0, p0

    invoke-direct {v0, v12}, Lnet/lingala/zip4j/core/HeaderReader;->readAndSaveAESExtraDataRecord(Lnet/lingala/zip4j/model/FileHeader;)V
    ...
    invoke-virtual {v12, v0}, Lnet/lingala/zip4j/model/FileHeader;->setFileName(Ljava/lang/String;)V
    ...
    .end local v26    # "signature":I
    :cond_e
    invoke-virtual {v5, v13}, Lnet/lingala/zip4j/model/CentralDirectory;->setFileHeaders(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v6, v0}, Lnet/lingala/zip4j/model/DigitalSignature;->setHeaderSignature(I)V
    ...
    invoke-virtual {v6, v0}, Lnet/lingala/zip4j/model/DigitalSignature;->setSizeOfData(I)V
    ...
    invoke-virtual {v6, v0}, Lnet/lingala/zip4j/model/DigitalSignature;->setSignatureData(Ljava/lang/String;)V
    :try_end_1
...
.method private readEndOfCentralDirectoryRecord()Lnet/lingala/zip4j/model/EndCentralDirRecord;
    ...
    invoke-direct/range {v18 .. v20}, Lnet/lingala/zip4j/exception/ZipException;-><init>(Ljava/lang/String;I)V
    ...
    .line 114
    .local v14, "pos":J
    new-instance v10, Lnet/lingala/zip4j/model/EndCentralDirRecord;

    invoke-direct {v10}, Lnet/lingala/zip4j/model/EndCentralDirRecord;-><init>()V

    .line 115
    .local v10, "endCentralDirRecord":Lnet/lingala/zip4j/model/EndCentralDirRecord;
    const/4 v6, 0x0
    ...
    invoke-static {v0, v9}, Lnet/lingala/zip4j/util/Raw;->readLeInt(Ljava/io/DataInput;[B)I
    ...
    invoke-static {v9, v0}, Lnet/lingala/zip4j/util/Raw;->readIntLittleEndian([BI)I
    ...
    .end local v9    # "ebs":[B
    .end local v10    # "endCentralDirRecord":Lnet/lingala/zip4j/model/EndCentralDirRecord;
    .end local v14    # "pos":J
    :catch_0
    move-exception v8
    ...
    invoke-direct {v0, v1, v8, v2}, Lnet/lingala/zip4j/exception/ZipException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;I)V
    ...
    .restart local v10    # "endCentralDirRecord":Lnet/lingala/zip4j/model/EndCentralDirRecord;
    .restart local v14    # "pos":J
    :cond_2
    const/16 v18, 0x4
    ...
    invoke-virtual {v10, v0, v1}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setSignature(J)V
    ...
    invoke-direct {v0, v1, v13}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-static {v13, v0}, Lnet/lingala/zip4j/util/Raw;->readShortLittleEndian([BI)I

    move-result v18

    move/from16 v0, v18

    invoke-virtual {v10, v0}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setNoOfThisDisk(I)V
    ...
    invoke-virtual {v10, v0}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setNoOfThisDiskStartOfCentralDir(I)V
    ...
    invoke-virtual {v10, v0}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setTotNoOfEntriesInCentralDirOnThisDisk(I)V
    ...
    invoke-virtual {v10, v0}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setTotNoOfEntriesInCentralDir(I)V
    ...
    invoke-direct {v0, v1, v11}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-static {v11, v0}, Lnet/lingala/zip4j/util/Raw;->readIntLittleEndian([BI)I

    move-result v18

    move/from16 v0, v18

    invoke-virtual {v10, v0}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setSizeOfCentralDir(I)V
    ...
    invoke-direct {v0, v11}, Lnet/lingala/zip4j/core/HeaderReader;->getLongByteFromIntByte([B)[B
    ...
    invoke-static {v12, v0}, Lnet/lingala/zip4j/util/Raw;->readLongLittleEndian([BI)J

    move-result-wide v18

    move-wide/from16 v0, v18

    invoke-virtual {v10, v0, v1}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setOffsetOfStartOfCentralDir(J)V
    ...
    invoke-virtual {v10, v5}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setCommentLength(I)V
    ...
    invoke-direct {v0, v1, v4}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-virtual {v10, v0}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setComment(Ljava/lang/String;)V

    .line 165
    invoke-virtual {v10, v4}, Lnet/lingala/zip4j/model/EndCentralDirRecord;->setCommentBytes([B)V
    ...
    invoke-virtual/range {v18 .. v19}, Lnet/lingala/zip4j/model/ZipModel;->setSplitArchive(Z)V
...
.method private readExtraDataRecords(I)Ljava/util/ArrayList;
    ...
    invoke-virtual {v4, v10, v11}, Lnet/lingala/zip4j/model/ExtraDataRecord;->setHeader(J)V
...
.method private readZip64EndCentralDirLocator()Lnet/lingala/zip4j/model/Zip64EndCentralDirLocator;
    ...
    invoke-virtual {v4, v6, v7}, Lnet/lingala/zip4j/model/Zip64EndCentralDirLocator;->setSignature(J)V
    ...
    invoke-virtual {v4, v6, v7}, Lnet/lingala/zip4j/model/Zip64EndCentralDirLocator;->setOffsetZip64EndOfCentralDirRec(J)V
...
.method private readZip64EndCentralDirRec()Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;
    ...
    iget-object v13, v0, Lnet/lingala/zip4j/core/HeaderReader;->zipModel:Lnet/lingala/zip4j/model/ZipModel;

    invoke-virtual {v13}, Lnet/lingala/zip4j/model/ZipModel;->getZip64EndCentralDirLocator()Lnet/lingala/zip4j/model/Zip64EndCentralDirLocator;
    ...
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/Zip64EndCentralDirLocator;->getOffsetZip64EndOfCentralDirRec()J
    ...
    iget-object v13, v0, Lnet/lingala/zip4j/core/HeaderReader;->zip4jRaf:Ljava/io/RandomAccessFile;
    ...
    invoke-direct {v12}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;-><init>()V

    .line 574
    .local v12, "zip64EndCentralDirRecord":Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;
    const/4 v13, 0x2
    ...
    invoke-direct {v0, v13, v6}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B

    .line 580
    const/4 v13, 0x0

    invoke-static {v6, v13}, Lnet/lingala/zip4j/util/Raw;->readIntLittleEndian([BI)I
    ...
    .end local v12    # "zip64EndCentralDirRecord":Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;
    :catch_0
    move-exception v2
    ...
    .restart local v12    # "zip64EndCentralDirRecord":Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;
    :cond_2
    int-to-long v14, v11

    :try_start_1
    invoke-virtual {v12, v14, v15}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setSignature(J)V
    ...
    invoke-direct {v0, v13, v7}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-virtual {v12, v14, v15}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setSizeOfZip64EndCentralDirRec(J)V
    ...
    invoke-direct {v0, v13, v10}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-virtual {v12, v14, v15}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setTotNoOfEntriesInCentralDirOnThisDisk(J)V
    ...
    invoke-virtual {v12, v14, v15}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setTotNoOfEntriesInCentralDir(J)V
    ...
    invoke-virtual {v12, v14, v15}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setSizeOfCentralDir(J)V
    ...
    invoke-virtual {v12, v14, v15}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setOffsetStartCenDirWRTStartDiskNo(J)V
    ...
    invoke-direct {v0, v13, v3}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B

    .line 633
    invoke-virtual {v12, v3}, Lnet/lingala/zip4j/model/Zip64EndCentralDirRecord;->setExtensibleDataSector([B)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public readLocalFileHeader(Lnet/lingala/zip4j/model/FileHeader;)Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    .line 828
    :cond_0
    new-instance v21, Lnet/lingala/zip4j/exception/ZipException;
    ...
    .line 835
    .local v20, "zip64ExtendedInfo":Lnet/lingala/zip4j/model/Zip64ExtendedInfo;
    ...
    .line 840
    .end local v20    # "zip64ExtendedInfo":Lnet/lingala/zip4j/model/Zip64ExtendedInfo;
    :cond_2
    ...
    invoke-direct {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;-><init>()V

    .line 850
    .local v13, "localFileHeader":Lnet/lingala/zip4j/model/LocalFileHeader;
    const/16 v21, 0x2
    ...
    .end local v13    # "localFileHeader":Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    invoke-direct {v0, v5}, Lnet/lingala/zip4j/exception/ZipException;-><init>(Ljava/lang/Throwable;)V
    ...
    .restart local v13    # "localFileHeader":Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setSignature(I)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setVersionNeededToExtract(I)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileNameUTF8Encoded(Z)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncrypted(Z)V

    .line 876
    :cond_5
    move-object/from16 v0, v18

    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setGeneralPurposeFlag([B)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setDataDescriptorExists(Z)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCompressionMethod(I)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setLastModFileTime(I)V
    ...
    invoke-virtual {v13, v0, v1}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCrc32(J)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCrcBuff([B)V
    ...
    invoke-virtual {v13, v0, v1}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCompressedSize(J)V
    ...
    invoke-virtual {v13, v0, v1}, Lnet/lingala/zip4j/model/LocalFileHeader;->setUncompressedSize(J)V
    ...
    invoke-virtual {v13, v9}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileNameLength(I)V
    ...
    invoke-virtual {v13, v6}, Lnet/lingala/zip4j/model/LocalFileHeader;->setExtraFieldLength(I)V
    ...
    invoke-direct {v0, v1, v8}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B

    .line 931
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->isFileNameUTF8Encoded()Z

    move-result v21

    move/from16 v0, v21

    invoke-static {v8, v0}, Lnet/lingala/zip4j/util/Zip4jUtil;->decodeFileName([BZ)Ljava/lang/String;
    ...
    .line 941
    :cond_a
    invoke-virtual {v13, v7}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileName(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v13}, Lnet/lingala/zip4j/core/HeaderReader;->readAndSaveExtraDataRecord(Lnet/lingala/zip4j/model/LocalFileHeader;)V
    ...
    invoke-virtual {v13, v0, v1}, Lnet/lingala/zip4j/model/LocalFileHeader;->setOffsetStartOfData(J)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setPassword([C)V

    .line 956
    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lnet/lingala/zip4j/core/HeaderReader;->readAndSaveZip64ExtendedInfo(Lnet/lingala/zip4j/model/LocalFileHeader;)V

    .line 958
    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lnet/lingala/zip4j/core/HeaderReader;->readAndSaveAESExtraDataRecord(Lnet/lingala/zip4j/model/LocalFileHeader;)V

    .line 960
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->isEncrypted()Z
    ...
    .line 962
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->getEncryptionMethod()I
    ...
    :cond_b
    :goto_3
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->getCrc32()J
    ...
    .line 982
    :cond_c
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->getCompressedSize()J
    ...
    .line 986
    :cond_d
    invoke-virtual {v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->getUncompressedSize()J
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileName(Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncryptionMethod(I)V
