...
.method private monthsUntil(Lorg/threeten/bp/LocalDate;)J
    .locals 10
    .param p1, "end"    # Lorg/threeten/bp/LocalDate;
...
.method public static now(Lorg/threeten/bp/Clock;)Lorg/threeten/bp/LocalDate;
    ...
    invoke-static {p0, v6}, Lorg/threeten/bp/jdk8/Jdk8Methods;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v4}, Lorg/threeten/bp/zone/ZoneRules;->getOffset(Lorg/threeten/bp/Instant;)Lorg/threeten/bp/ZoneOffset;
    ...
    invoke-static {v2, v3, v6, v7}, Lorg/threeten/bp/jdk8/Jdk8Methods;->floorDiv(JJ)J
...
.method public static ofEpochDay(J)Lorg/threeten/bp/LocalDate;
    ...
    .prologue
    .line 282
    sget-object v13, Lorg/threeten/bp/temporal/ChronoField;->EPOCH_DAY:Lorg/threeten/bp/temporal/ChronoField;

    move-wide/from16 v0, p0

    invoke-virtual {v13, v0, v1}, Lorg/threeten/bp/temporal/ChronoField;->checkValidValue(J)J
    ...
    .line 310
    sget-object v13, Lorg/threeten/bp/temporal/ChronoField;->YEAR:Lorg/threeten/bp/temporal/ChronoField;

    invoke-virtual {v13, v14, v15}, Lorg/threeten/bp/temporal/ChronoField;->checkValidIntValue(J)I

    move-result v12

    .line 311
    .local v12, "year":I
    new-instance v13, Lorg/threeten/bp/LocalDate;

    invoke-direct {v13, v12, v11, v6}, Lorg/threeten/bp/LocalDate;-><init>(III)V
...
.method public static ofYearDay(II)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {v4, v6, v7}, Lorg/threeten/bp/temporal/ChronoField;->checkValidValue(J)J
    ...
    invoke-virtual {v4, v6, v7}, Lorg/threeten/bp/chrono/IsoChronology;->isLeapYear(J)Z
    ...
    const-string v6, "Invalid date \'DayOfYear 366\' as \'"
    ...
    invoke-static {v4}, Lorg/threeten/bp/Month;->of(I)Lorg/threeten/bp/Month;

    move-result-object v3

    .line 262
    .local v3, "moy":Lorg/threeten/bp/Month;
    invoke-virtual {v3, v1}, Lorg/threeten/bp/Month;->firstDayOfYear(Z)I

    move-result v4

    invoke-virtual {v3, v1}, Lorg/threeten/bp/Month;->length(Z)I
    ...
    invoke-virtual {v3, v4, v5}, Lorg/threeten/bp/Month;->plus(J)Lorg/threeten/bp/Month;
    ...
    .line 267
    .local v0, "dom":I
    invoke-static {p0, v3, v0}, Lorg/threeten/bp/LocalDate;->create(ILorg/threeten/bp/Month;I)Lorg/threeten/bp/LocalDate;
...
.method static readExternal(Ljava/io/DataInput;)Lorg/threeten/bp/LocalDate;
    ...
    invoke-static {v2, v1, v0}, Lorg/threeten/bp/LocalDate;->of(III)Lorg/threeten/bp/LocalDate;
...
.method public atStartOfDay(Lorg/threeten/bp/ZoneId;)Lorg/threeten/bp/ZonedDateTime;
    ...
    invoke-virtual {p0, v3}, Lorg/threeten/bp/LocalDate;->atTime(Lorg/threeten/bp/LocalTime;)Lorg/threeten/bp/LocalDateTime;

    move-result-object v0

    .line 1622
    .local v0, "ldt":Lorg/threeten/bp/LocalDateTime;
    instance-of v3, p1, Lorg/threeten/bp/ZoneOffset;
    ...
    .line 1629
    .end local v1    # "rules":Lorg/threeten/bp/zone/ZoneRules;
...
.method public atTime(Lorg/threeten/bp/OffsetTime;)Lorg/threeten/bp/OffsetDateTime;
    .locals 2
    .param p1, "time"    # Lorg/threeten/bp/OffsetTime;
...
.method public compareTo(Lorg/threeten/bp/chrono/ChronoLocalDate;)I
    ...
    .end local p1    # "other":Lorg/threeten/bp/chrono/ChronoLocalDate;
    ...
    .restart local p1    # "other":Lorg/threeten/bp/chrono/ChronoLocalDate;
    :cond_0
...
.method compareTo0(Lorg/threeten/bp/LocalDate;)I
    ...
    iget v2, p1, Lorg/threeten/bp/LocalDate;->year:I
    ...
    iget-short v2, p1, Lorg/threeten/bp/LocalDate;->month:S
...
.method public getDayOfWeek()Lorg/threeten/bp/DayOfWeek;
    ...
    invoke-static {v2, v3, v1}, Lorg/threeten/bp/jdk8/Jdk8Methods;->floorMod(JI)I
...
.method public plus(JLorg/threeten/bp/temporal/TemporalUnit;)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {p0, v2, v3}, Lorg/threeten/bp/LocalDate;->plusYears(J)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {p0, v1, v2, v3}, Lorg/threeten/bp/LocalDate;->with(Lorg/threeten/bp/temporal/TemporalField;J)Lorg/threeten/bp/LocalDate;
...
.method public plusDays(J)Lorg/threeten/bp/LocalDate;
    ...
    .line 1183
    .end local p0    # "this":Lorg/threeten/bp/LocalDate;
    :goto_0
    return-object p0

    .line 1182
    .restart local p0    # "this":Lorg/threeten/bp/LocalDate;
    :cond_0
    invoke-virtual {p0}, Lorg/threeten/bp/LocalDate;->toEpochDay()J
...
.method public plusMonths(J)Lorg/threeten/bp/LocalDate;
    ...
    .restart local p0    # "this":Lorg/threeten/bp/LocalDate;
    :cond_0
    iget v6, p0, Lorg/threeten/bp/LocalDate;->year:I

    int-to-long v6, v6

    mul-long/2addr v6, v10

    iget-short v8, p0, Lorg/threeten/bp/LocalDate;->month:S
    ...
    .line 1141
    .local v4, "newMonth":I
    iget-short v6, p0, Lorg/threeten/bp/LocalDate;->day:S

    invoke-static {v5, v4, v6}, Lorg/threeten/bp/LocalDate;->resolvePreviousValid(III)Lorg/threeten/bp/LocalDate;
...
.method public toEpochDay()J
    ...
    .line 1636
    .local v4, "y":J
    iget-short v6, p0, Lorg/threeten/bp/LocalDate;->month:S
...
.method public toString()Ljava/lang/String;
    ...
    .line 1823
    iget v4, p0, Lorg/threeten/bp/LocalDate;->year:I
...
.method public until(Lorg/threeten/bp/temporal/Temporal;Lorg/threeten/bp/temporal/TemporalUnit;)J
    ...
    .line 1418
    .local v0, "end":Lorg/threeten/bp/LocalDate;
    ...
    .line 1420
    :pswitch_0
    invoke-virtual {p0, v0}, Lorg/threeten/bp/LocalDate;->daysUntil(Lorg/threeten/bp/LocalDate;)J
    ...
    .line 1422
    :pswitch_2
    invoke-direct {p0, v0}, Lorg/threeten/bp/LocalDate;->monthsUntil(Lorg/threeten/bp/LocalDate;)J
    ...
    invoke-virtual {v0, v1}, Lorg/threeten/bp/LocalDate;->getLong(Lorg/threeten/bp/temporal/TemporalField;)J
...
.method public until(Lorg/threeten/bp/chrono/ChronoLocalDate;)Lorg/threeten/bp/Period;
    ...
    .line 1481
    .local v2, "end":Lorg/threeten/bp/LocalDate;
    invoke-direct {v2}, Lorg/threeten/bp/LocalDate;->getProlepticMonth()J
    ...
    iget-short v8, v2, Lorg/threeten/bp/LocalDate;->day:S

    iget-short v9, p0, Lorg/threeten/bp/LocalDate;->day:S
    ...
    .line 1485
    invoke-virtual {p0, v4, v5}, Lorg/threeten/bp/LocalDate;->plusMonths(J)Lorg/threeten/bp/LocalDate;

    move-result-object v0

    .line 1486
    .local v0, "calcDate":Lorg/threeten/bp/LocalDate;
    ...
    .line 1491
    .end local v0    # "calcDate":Lorg/threeten/bp/LocalDate;
    :cond_0
    :goto_0
    const-wide/16 v8, 0xc
    ...
    invoke-static {v8, v3, v1}, Lorg/threeten/bp/Period;->of(III)Lorg/threeten/bp/Period;
...
.method public with(Lorg/threeten/bp/temporal/TemporalField;J)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {p0, v1}, Lorg/threeten/bp/LocalDate;->withDayOfMonth(I)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {p0, v1}, Lorg/threeten/bp/LocalDate;->withDayOfYear(I)Lorg/threeten/bp/LocalDate;
    ...
    invoke-virtual {p0, v1}, Lorg/threeten/bp/LocalDate;->withMonth(I)Lorg/threeten/bp/LocalDate;
