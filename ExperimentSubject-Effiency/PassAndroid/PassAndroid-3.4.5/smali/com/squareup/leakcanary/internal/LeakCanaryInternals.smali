...
.field private static final NOTIFICATION_CHANNEL_ID:Ljava/lang/String; = "leakcanary"
...
.method public static isInServiceProcess(Landroid/content/Context;Ljava/lang/Class;)Z
    ...
    iget-object v6, v14, Landroid/content/pm/ApplicationInfo;->processName:Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v10, v3, v14}, Landroid/content/pm/PackageManager;->getServiceInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ServiceInfo;
    :try_end_1
    ...
    .line 113
    const-string v14, "Did not expect service %s to run in main process %s"
    ...
    invoke-static {v14, v15}, Lcom/squareup/leakcanary/CanaryLog;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v14, "Could not get package info for %s"
    ...
    invoke-static {v4, v14, v15}, Lcom/squareup/leakcanary/CanaryLog;->d(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 124
    .local v12, "runningProcesses":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    if-eqz v12, :cond_2
    ...
    .line 133
    const-string v14, "Could not find running process for %d"
...
.method public static showNotification(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;I)V
    ...
    .line 154
    sget v4, Lcom/squareup/leakcanary/R$string;->leak_canary_notification_channel:I
    ...
    invoke-static {v1, v3, v0}, Lcom/squareup/leakcanary/internal/LeakCanaryInternals;->setupNotificationChannel(Ljava/lang/String;Landroid/app/NotificationManager;Landroid/app/Notification$Builder;)V
