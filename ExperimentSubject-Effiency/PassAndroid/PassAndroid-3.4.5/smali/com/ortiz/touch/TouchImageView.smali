...
.method static synthetic access$1000(Lcom/ortiz/touch/TouchImageView;)Landroid/view/ScaleGestureDetector;
    .locals 1
    .param p0, "x0"    # Lcom/ortiz/touch/TouchImageView;
...
.method static synthetic access$1200(Lcom/ortiz/touch/TouchImageView;Lcom/ortiz/touch/TouchImageView$State;)V
    .locals 0
    .param p0, "x0"    # Lcom/ortiz/touch/TouchImageView;
    .param p1, "x1"    # Lcom/ortiz/touch/TouchImageView$State;
...
.method static synthetic access$402(Lcom/ortiz/touch/TouchImageView;Lcom/ortiz/touch/TouchImageView$Fling;)Lcom/ortiz/touch/TouchImageView$Fling;
    .locals 0
    .param p0, "x0"    # Lcom/ortiz/touch/TouchImageView;
    .param p1, "x1"    # Lcom/ortiz/touch/TouchImageView$Fling;
...
.method private fitImageToView()V
    ...
    .prologue
    .line 547
    invoke-virtual/range {p0 .. p0}, Lcom/ortiz/touch/TouchImageView;->getDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Lcom/ortiz/touch/TouchImageView;->matrix:Landroid/graphics/Matrix;

    if-eqz v2, :cond_0

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/ortiz/touch/TouchImageView;->prevMatrix:Landroid/graphics/Matrix;
    ...
    iget v2, v0, Lcom/ortiz/touch/TouchImageView;->viewWidth:I
    ...
    iget v2, v0, Lcom/ortiz/touch/TouchImageView;->viewHeight:I
    ...
    .line 564
    .local v22, "scaleY":F
    sget-object v2, Lcom/ortiz/touch/TouchImageView$1;->$SwitchMap$android$widget$ImageView$ScaleType:[I

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/ortiz/touch/TouchImageView;->mScaleType:Landroid/widget/ImageView$ScaleType;
    ...
    iput v2, v0, Lcom/ortiz/touch/TouchImageView;->matchViewWidth:F
    ...
    iput v2, v0, Lcom/ortiz/touch/TouchImageView;->matchViewHeight:F

    .line 598
    invoke-virtual/range {p0 .. p0}, Lcom/ortiz/touch/TouchImageView;->isZoomed()Z
    ...
    iget-boolean v2, v0, Lcom/ortiz/touch/TouchImageView;->imageRenderedAtLeastOnce:Z
    ...
    iput v2, v0, Lcom/ortiz/touch/TouchImageView;->normalizedScale:F

    .line 649
    :goto_2
    invoke-direct/range {p0 .. p0}, Lcom/ortiz/touch/TouchImageView;->fixTrans()V
    ...
    invoke-virtual {v0, v2}, Lcom/ortiz/touch/TouchImageView;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget v2, v0, Lcom/ortiz/touch/TouchImageView;->prevMatchViewWidth:F
    ...
    iget v2, v0, Lcom/ortiz/touch/TouchImageView;->prevMatchViewHeight:F
    ...
    .line 613
    :cond_3
    invoke-direct/range {p0 .. p0}, Lcom/ortiz/touch/TouchImageView;->savePreviousImageValues()V
    ...
    iget-object v3, v0, Lcom/ortiz/touch/TouchImageView;->m:[F
    ...
    iget-object v2, v0, Lcom/ortiz/touch/TouchImageView;->m:[F

    const/4 v3, 0x0

    move-object/from16 v0, p0

    iget v7, v0, Lcom/ortiz/touch/TouchImageView;->matchViewWidth:F
    ...
    iget v8, v0, Lcom/ortiz/touch/TouchImageView;->normalizedScale:F
    ...
    iget v7, v0, Lcom/ortiz/touch/TouchImageView;->matchViewHeight:F
    ...
    iget v3, v0, Lcom/ortiz/touch/TouchImageView;->normalizedScale:F

    mul-float v5, v2, v3

    .line 634
    .local v5, "prevActualWidth":F
    invoke-direct/range {p0 .. p0}, Lcom/ortiz/touch/TouchImageView;->getImageWidth()F
    ...
    iget v7, v0, Lcom/ortiz/touch/TouchImageView;->prevViewWidth:I

    move-object/from16 v0, p0

    iget v8, v0, Lcom/ortiz/touch/TouchImageView;->viewWidth:I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/ortiz/touch/TouchImageView;->getImageHeight()F
    ...
    iget v15, v0, Lcom/ortiz/touch/TouchImageView;->prevViewHeight:I

    move-object/from16 v0, p0

    iget v0, v0, Lcom/ortiz/touch/TouchImageView;->viewHeight:I

    move/from16 v16, v0

    move-object/from16 v10, p0

    invoke-direct/range {v10 .. v17}, Lcom/ortiz/touch/TouchImageView;->translateMatrixAfterRotate(IFFFIII)V
...
.method private fixTrans()V
    ...
    .line 447
    iget-object v4, p0, Lcom/ortiz/touch/TouchImageView;->matrix:Landroid/graphics/Matrix;

    iget-object v5, p0, Lcom/ortiz/touch/TouchImageView;->m:[F

    invoke-virtual {v4, v5}, Landroid/graphics/Matrix;->getValues([F)V

    .line 448
    iget-object v4, p0, Lcom/ortiz/touch/TouchImageView;->m:[F
    ...
    invoke-direct {p0, v2, v4, v5}, Lcom/ortiz/touch/TouchImageView;->getFixTrans(FFF)F
    ...
    invoke-direct {p0, v3, v4, v5}, Lcom/ortiz/touch/TouchImageView;->getFixTrans(FFF)F
...
.method private scaleImage(DFFZ)V
    ...
    iget v2, p0, Lcom/ortiz/touch/TouchImageView;->superMaxScale:F
    ...
    iget v2, p0, Lcom/ortiz/touch/TouchImageView;->maxScale:F
...
.method private setState(Lcom/ortiz/touch/TouchImageView$State;)V
    .locals 0
    .param p1, "state"    # Lcom/ortiz/touch/TouchImageView$State;
...
.method private sharedConstructing(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/ortiz/touch/TouchImageView$PrivateOnTouchListener;-><init>(Lcom/ortiz/touch/TouchImageView;Lcom/ortiz/touch/TouchImageView$1;)V
...
.method private transformCoordBitmapToTouch(FF)Landroid/graphics/PointF;
    ...
    .prologue
    .line 1089
    iget-object v6, p0, Lcom/ortiz/touch/TouchImageView;->matrix:Landroid/graphics/Matrix;

    iget-object v7, p0, Lcom/ortiz/touch/TouchImageView;->m:[F
    ...
    .line 1094
    .local v5, "py":F
    iget-object v6, p0, Lcom/ortiz/touch/TouchImageView;->m:[F
...
.method public getScrollPosition()Landroid/graphics/PointF;
    ...
    invoke-direct {p0, v4, v5, v6}, Lcom/ortiz/touch/TouchImageView;->transformCoordTouchToBitmap(FFZ)Landroid/graphics/PointF;
...
.method public getZoomedRect()Landroid/graphics/RectF;
    ...
    .line 218
    iget-object v4, p0, Lcom/ortiz/touch/TouchImageView;->mScaleType:Landroid/widget/ImageView$ScaleType;
    ...
    .line 221
    :cond_0
    invoke-direct {p0, v6, v6, v7}, Lcom/ortiz/touch/TouchImageView;->transformCoordTouchToBitmap(FFZ)Landroid/graphics/PointF;
    ...
    invoke-direct {p0, v4, v5, v7}, Lcom/ortiz/touch/TouchImageView;->transformCoordTouchToBitmap(FFZ)Landroid/graphics/PointF;
...
.method protected onMeasure(II)V
    ...
    .line 517
    :cond_0
    invoke-virtual {p0, v8, v8}, Lcom/ortiz/touch/TouchImageView;->setMeasuredDimension(II)V
    ...
    invoke-direct {p0, v5, v6, v2}, Lcom/ortiz/touch/TouchImageView;->setViewSize(III)I

    move-result v7

    iput v7, p0, Lcom/ortiz/touch/TouchImageView;->viewWidth:I

    .line 528
    invoke-direct {p0, v3, v4, v1}, Lcom/ortiz/touch/TouchImageView;->setViewSize(III)I

    move-result v7

    iput v7, p0, Lcom/ortiz/touch/TouchImageView;->viewHeight:I

    .line 533
    iget v7, p0, Lcom/ortiz/touch/TouchImageView;->viewWidth:I

    iget v8, p0, Lcom/ortiz/touch/TouchImageView;->viewHeight:I

    invoke-virtual {p0, v7, v8}, Lcom/ortiz/touch/TouchImageView;->setMeasuredDimension(II)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object v1, p0, Lcom/ortiz/touch/TouchImageView;->m:[F
    ...
    iput v1, p0, Lcom/ortiz/touch/TouchImageView;->prevMatchViewHeight:F
    ...
    iput v1, p0, Lcom/ortiz/touch/TouchImageView;->prevMatchViewWidth:F
    ...
    iput v1, p0, Lcom/ortiz/touch/TouchImageView;->prevViewHeight:I
    ...
    iput v1, p0, Lcom/ortiz/touch/TouchImageView;->prevViewWidth:I
    ...
    iput-boolean v1, p0, Lcom/ortiz/touch/TouchImageView;->imageRenderedAtLeastOnce:Z
...
.method public setOnTouchImageViewListener(Lcom/ortiz/touch/TouchImageView$OnTouchImageViewListener;)V
    .locals 0
    .param p1, "l"    # Lcom/ortiz/touch/TouchImageView$OnTouchImageViewListener;
...
.method public setZoom(FFFLandroid/widget/ImageView$ScaleType;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/ortiz/touch/TouchImageView$ZoomVariables;-><init>(Lcom/ortiz/touch/TouchImageView;FFFLandroid/widget/ImageView$ScaleType;)V
...
.method public setZoom(Lcom/ortiz/touch/TouchImageView;)V
    .locals 5
    .param p1, "img"    # Lcom/ortiz/touch/TouchImageView;
    ...
    invoke-virtual {p0, v1, v2, v3, v4}, Lcom/ortiz/touch/TouchImageView;->setZoom(FFFLandroid/widget/ImageView$ScaleType;)V
