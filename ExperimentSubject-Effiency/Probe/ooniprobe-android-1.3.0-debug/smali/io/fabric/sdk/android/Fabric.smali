...
.method initializeKits(Landroid/content/Context;)V
    ...
    invoke-interface {v4, v6, v5}, Lio/fabric/sdk/android/Logger;->isLoggable(Ljava/lang/String;I)Z
    ...
    .line 431
    .end local v4    # "initInfo":Ljava/lang/StringBuilder;
    :cond_1
    const/4 v4, 0x0

    .line 434
    .restart local v4    # "initInfo":Ljava/lang/StringBuilder;
    :goto_1
    invoke-interface {v3}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .line 435
    .local v8, "kit":Lio/fabric/sdk/android/Kit;
    iget-object v9, v8, Lio/fabric/sdk/android/Kit;->initializationTask:Lio/fabric/sdk/android/InitializationTask;

    iget-object v10, v2, Lio/fabric/sdk/android/Onboarding;->initializationTask:Lio/fabric/sdk/android/InitializationTask;

    invoke-virtual {v9, v10}, Lio/fabric/sdk/android/InitializationTask;->addDependency(Lio/fabric/sdk/android/services/concurrency/Task;)V

    .line 437
    iget-object v9, p0, Lio/fabric/sdk/android/Fabric;->kits:Ljava/util/Map;

    invoke-virtual {p0, v9, v8}, Lio/fabric/sdk/android/Fabric;->addAnnotatedDependencies(Ljava/util/Map;Lio/fabric/sdk/android/Kit;)V
    ...
    .line 447
    .end local v8    # "kit":Lio/fabric/sdk/android/Kit;
    :cond_2
    goto :goto_2
