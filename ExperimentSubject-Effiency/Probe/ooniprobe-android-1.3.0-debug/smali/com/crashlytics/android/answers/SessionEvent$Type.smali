...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/crashlytics/android/answers/SessionEvent$Type;->PAUSE:Lcom/crashlytics/android/answers/SessionEvent$Type;
    ...
    invoke-direct {v5, v7, v8}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/crashlytics/android/answers/SessionEvent$Type;->STOP:Lcom/crashlytics/android/answers/SessionEvent$Type;
    ...
    invoke-direct {v7, v9, v10}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/crashlytics/android/answers/SessionEvent$Type;->CRASH:Lcom/crashlytics/android/answers/SessionEvent$Type;

    .line 21
    new-instance v9, Lcom/crashlytics/android/answers/SessionEvent$Type;

    const-string v11, "INSTALL"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/crashlytics/android/answers/SessionEvent$Type;->INSTALL:Lcom/crashlytics/android/answers/SessionEvent$Type;

    .line 22
    new-instance v11, Lcom/crashlytics/android/answers/SessionEvent$Type;

    const-string v13, "CUSTOM"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lcom/crashlytics/android/answers/SessionEvent$Type;->CUSTOM:Lcom/crashlytics/android/answers/SessionEvent$Type;

    .line 23
    new-instance v13, Lcom/crashlytics/android/answers/SessionEvent$Type;

    const-string v15, "PREDEFINED"

    const/4 v14, 0x7

    invoke-direct {v13, v15, v14}, Lcom/crashlytics/android/answers/SessionEvent$Type;-><init>(Ljava/lang/String;I)V

    sput-object v13, Lcom/crashlytics/android/answers/SessionEvent$Type;->PREDEFINED:Lcom/crashlytics/android/answers/SessionEvent$Type;

    .line 15
    const/16 v15, 0x8

    new-array v15, v15, [Lcom/crashlytics/android/answers/SessionEvent$Type;
    ...
    sput-object v15, Lcom/crashlytics/android/answers/SessionEvent$Type;->$VALUES:[Lcom/crashlytics/android/answers/SessionEvent$Type;
