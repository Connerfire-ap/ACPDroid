...
.method next()V
    ...
    .line 201
    :try_start_2
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableBufferBoundarySupplier$BufferBoundarySupplierObserver;->buffer:Ljava/util/Collection;

    .line 202
    .local v4, "b":Ljava/util/Collection;, "TU;"
    if-nez v4, :cond_1
    ...
    invoke-virtual {p0, v4, v5, p0}, Lio/reactivex/internal/operators/observable/ObservableBufferBoundarySupplier$BufferBoundarySupplierObserver;->fastPathEmit(Ljava/lang/Object;ZLio/reactivex/disposables/Disposable;)V

    .line 211
    return-void

    .line 206
    .end local v4    # "b":Ljava/util/Collection;, "TU;"
    :catchall_0
    move-exception v4
