...
.method constructor <init>(Lio/reactivex/CompletableObserver;Lio/reactivex/functions/Function;I)V
    ...
    .line 65
    .local p0, "this":Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;, "Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver<TT;>;"
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver$InnerObserver;-><init>(Lio/reactivex/CompletableObserver;Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;)V
...
.method drain()V
    ...
    .line 186
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->actual:Lio/reactivex/CompletableObserver;
    ...
    .line 194
    :try_start_1
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->mapper:Lio/reactivex/functions/Function;
    ...
    .line 201
    .local v4, "c":Lio/reactivex/CompletableSource;
    nop
    ...
    .line 195
    .end local v4    # "c":Lio/reactivex/CompletableSource;
    :catchall_0
    move-exception v2
    ...
    .line 198
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->queue:Lio/reactivex/internal/fuseable/SimpleQueue;

    invoke-interface {v4}, Lio/reactivex/internal/fuseable/SimpleQueue;->clear()V

    .line 199
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->actual:Lio/reactivex/CompletableObserver;

    invoke-interface {v4, v2}, Lio/reactivex/CompletableObserver;->onError(Ljava/lang/Throwable;)V
    ...
    .line 177
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->queue:Lio/reactivex/internal/fuseable/SimpleQueue;
...
.method public onSubscribe(Lio/reactivex/disposables/Disposable;)V
    ...
    .line 81
    iput v1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->sourceMode:I

    .line 82
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->queue:Lio/reactivex/internal/fuseable/SimpleQueue;

    .line 83
    iput-boolean v2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapCompletable$SourceObserver;->done:Z
